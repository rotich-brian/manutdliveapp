...
public class TransfersFragment extends Fragment implements SelectListener{
        ...
        if (isConnected()) {
            ...
            if (nextToken.equals("")){
                ...
                url = "https://www.googleapis.com/blogger/v3/blogs/"+Constants.BLOG_ID+
                        "/posts?maxResults="+Constants.MAX_RESULTS+"&key="+Constants.API_KEY+"&labels="+Constants.TRANSFERS_LABEL;
            }
                ...
                url = "https://www.googleapis.com/blogger/v3/blogs/"+Constants.BLOG_ID+
                        ...
                        "&pageToken="+nextToken+"&key="+Constants.API_KEY+"&labels="+Constants.TRANSFERS_LABEL;
            }
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        adapterPost = new AdapterPost(getContext(), postArrayList, TransfersFragment.this);
                        recyclerView.setAdapter(adapterPost);
                        //adapterPost.setDataset(postArrayList);
    ...
    public void loadMore() {
        ...
        if (nextToken.equals("")){
            ...
            Log.d(TAG, "loadPosts: Next Page Token is empty/end, no more posts");
            Toast.makeText(getContext(), "You are Caught up, no more transfer news", Toast.LENGTH_SHORT).show();
            swipeRefresh.setRefreshing(false);
            return;
        }
        else {
