...
public class HomeFragment extends Fragment implements SelectListener{
    ...
    private void showInternetSnackBar() {
        ...
        View layout_dialog = LayoutInflater.from(getContext()).inflate(R.layout.check_internet_dialog, null);
        ...
        if (isConnected()) {
            ...
            if (nextToken.equals("")){
                ...
                url = "https://www.googleapis.com/blogger/v3/blogs/"+Constants.BLOG_ID+
                        "/posts?maxResults="+Constants.MAX_RESULTS+"&key="+Constants.API_KEY;
            }
            else if (nextToken.equals("end")){
                Log.d(TAG, "loadPosts: Next Page Token is empty/end, no more posts");
                Toast.makeText(getContext(), "You are Caught up, no more news", Toast.LENGTH_SHORT).show();
                ...
                url = "https://www.googleapis.com/blogger/v3/blogs/"+Constants.BLOG_ID+
                        ...
                        "&pageToken="+nextToken+"&key="+Constants.API_KEY;
            }
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        adapterPost = new AdapterPost(getContext(), postArrayList, HomeFragment.this);
